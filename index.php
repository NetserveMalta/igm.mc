...
<head>
	...
	<meta name="author" content="Netserve Malta" />
	...
	<link rel="stylesheet" href="override.css?v=<?php time() ?>" type="text/css" />
	...
	<!-- Document Title
	============================================= -->
	<title>IGM | Institut de Gemmologie Monaco (Privé)</title>
		...
		<header id="header" class="transparent-header dark full-header no-sticky">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="/" class="standard-logo" data-dark-logo="images/logo.png"><img src="images/logo.png" alt="IGM Logo"></a>
			...
			<div class="force-full-screen full-screen dark section nopadding nomargin noborder ohidden">
				...
				<div class="container clearfix">
					<div class="slider-caption slider-caption-center">
						<h2 data-animate="fadeInUp" class="red">Institut Gemmologie Monaco (Privé)</h2>
						<p data-animate="fadeInUp" data-delay="200" style="text-transform: uppercase;">Coming Soon with our new website!!</p>
						<p data-animate="fadeInUp" data-delay="400">Do not hesitate to contact us for any information or</p>
						<a data-animate="fadeInUp" data-delay="600" data-lightbox="inline" href="#myModal1" class="button button-border button-light button-rounded button-large noleftmargin nobottommargin" style="margin-top: 30px;">Subscribe to our newsletter</a>
					</div>
...
<!-- 						<a data-animate="fadeInUp" data-delay="600" href="#" class="button button-3d button-teal button-large nobottommargin" style="margin: 30px 0 0 10px;">Buy Now</a> -->
				...
				<div class="video-wrap">
					<video poster="video/igm_landing.mp4" preload="auto" loop autoplay muted>
						<source src='video/igm_landing.mp4' type='video/mp4' />
						<source src='video/igm_landing.webm' type='video/webm' />
					</video>
					<div class="video-overlay" style="background-color: rgba(0,0,0,0.4);"></div>
				</div>
				
				<!-- Modal -->
				<div class="modal1 mfp-hide subscribe-widget center" id="myModal1">
					<div class="block dark divcenter" style="background-size: cover; max-width: 700px;" data-height-lg="400">
						<div style="padding: 100px;" class="center">
							<div class="heading-block nobottomborder bottommargin-sm" style="max-width:500px;">
								<h3>IGM Newsletter</h3>
								<span>Get our latest updates!</span>
							</div>
							
							<div class="widget-subscribe-form-result"></div>
							
							<form class="widget-subscribe-form2" action="include/subscribe.php" role="form" method="post" style="max-width: 350px; padding-left:140px;" class="center">
								<input type="email" id="widget-subscribe-form2-email" name="widget-subscribe-form-email" class="form-control input-lg not-dark required email center" placeholder="Enter your Email">
		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyright &copy; <?= date("Y") ?> IGM. All Rights Reserved.<br>
<!-- 						<div class="copyright-links"><a href="#">Terms of Use</a> / <a href="#">Privacy Policy</a></div> -->
					</div>
					
					<div class="col_half col_last tright">
						<div class="fright clearfix">
							6, Impasse de la Fontaine <span class="middot">&middot;</span> 98000 - Principaut&eacute; de Monaco
							<!--
...
-->
						...
						<i class="icon-envelope2"></i> info@igm.mc <span class="middot">&middot;</span> <i class="icon-headphones"></i> +377.97708229<br />
						Our mailboxes are officially protected by MX Guarddog <a href="http://mxguarddog.com/firewall/">spam firewall</a>
						<?php /* <span class="middot">&middot;</span> <i class="icon-skype2"></i> CanvasOnSkype */ ?>
					</div>
